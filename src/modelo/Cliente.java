...
public class Cliente extends Persona {
    ...
    try{
        ...
        cn.cerrar_conexion();
        JOptionPane.showMessageDialog(null,Integer.toString(ejecutar)+" registros ingresados","Agregar",JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public DefaultTableModel leer(){
        ...
        try{
            ...
            String columnas[]={"ID","Nit","Nombres","Apellidos","Dirección","Teléfono","Nacimiento"};
